...
# Script parameters.
# flash_prior <- list(prior.point.normal(),prior.point.normal())
# flash_prior <- list(prior.point.normal(),prior.nonnegative())
flash_prior <- list(prior.nonnegative(),prior.point.normal())
# flash_prior <- list(prior.nonnegative(),prior.nonnegative())
