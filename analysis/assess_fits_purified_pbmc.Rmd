...
choices of $K$ (the number of "topics").
...
ggsave("loglik_vs_k_purified_pbmc.eps",p1,height = 3,width = 3.25)
ggsave("progress_loglik_purified_pbmc.eps",p2,height = 6,width = 9)
ggsave("progress_res_purified_pbmc.eps",p3,height = 6,width = 9)
```
