...
ggsave("loglik_vs_k_pbmc_purified.eps",p1,height = 3,width = 3.25)
ggsave("progress_loglik_pbmc_purified.eps",p2,height = 6,width = 9)
ggsave("progress_res_pbmc_purified.eps",p3,height = 6,width = 9)
```
