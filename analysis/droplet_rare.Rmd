...
capture continuous variation in the ciliated cells:
...
ggsave("../plots/volcano_plots_droplet_rare.eps",
...
+ [topic 1 (tuft cells)](volcano_plots/volcano_plot_droplet_rare_tuft.html)

+ [topic 2 (neuroendocrine cells)](volcano_plots/volcano_plot_droplet_rare_neuroendocrine.html)

+ [topics 3 + 4 (ciliated cells)](volcano_plots/volcano_plot_droplet_rare_ciliated.html)

+ [topic 3](volcano_plots/volcano_plot_droplet_rare_k3.html)

+ [topic 4](volcano_plots/volcano_plot_droplet_rare_k4.html)

+ [topic 5](volcano_plots/volcano_plot_droplet_rare_k5.html)
