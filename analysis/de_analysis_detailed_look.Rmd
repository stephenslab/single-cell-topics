...
To check that the posterior calculations are reasonably accurate, we
can perform the DE analysis twice, and compare the $z$-scores returned
by the two `de_analysis` runs.
...
when we compare the $z$-scores estimated by these two runs:
