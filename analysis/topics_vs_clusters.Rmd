...
expression profile (cells) as a *mixture* of "gene programs" that are
estimated from the data. These gene expression programs are the
topics.
...
mixture of $k = 3$ "gene programs" (the topics).
...
From this plot, we see that the samples are either primarily
attributed to a single gene program (topic), or roughly equally
attributed to all three gene programs.
