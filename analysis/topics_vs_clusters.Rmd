...
data. An alternative is to use a topic model, which explains each gene
expression profile (cells) as a *mixture* of "gene expression
programs" that are estimated from the data. These gene expression
programs are the topics.
