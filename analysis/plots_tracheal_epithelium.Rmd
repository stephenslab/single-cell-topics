...
p3 <- zscores_scatterplot(diff_count_clusters_pulseseq,
  ...
  labs(x = "cluster Cil",y = "topic 7",title = "sqrt(z-score)")
...
p8 <- zscores_scatterplot(diff_count_clusters_droplet,
  ...
  labs(x = "cluster G",y = "topic 1",title = "sqrt(z-score)")
...
epithelial airway data sets that do not break down into distinct
clusters.
