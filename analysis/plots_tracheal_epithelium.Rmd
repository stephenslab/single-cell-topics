...
Volcano plot for "Cil" cluster in droplet data. Notes: The cluster for
the ciliated cells is one of the best separated clusters in both the
droplet and pulse-seq data. Marker genes and transcription factors for
ciliated cells mentioned in Montoro *et al* (2018) are shown in black.
