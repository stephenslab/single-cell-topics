...
```{r droplet-pca-with-topics-2, fig.height=1.75, fig.width=8}
...
```{r droplet-clustering-1, fig.height=4.5, fig.width=6}
...
```{r droplet-structure-plot-abundan, fig.width=8, fig.height=2}
set.seed(1)
