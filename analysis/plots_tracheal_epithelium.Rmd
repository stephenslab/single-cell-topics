...
TO DO: In addition to the Structure plots, add PCA plots summarizing
(1) the clustering, and (2) how the clustering corresponds to top
marker genes (e.g., *Krt13* for hillock cells).
...
diff_count_hillock_pulseseq <-
  within(diff_count_hillock_pulseseq,colmeans <- colmeans + 1e-5)
