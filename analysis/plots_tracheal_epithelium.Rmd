...
discovered ionocyte cell type. Gene expression in these cells is not
fully captured by any single topic.
...
We do not identify a cluster for ionocytes in the droplet data,
probably because only a handful of cells in this data set appear to be
ionocytes, at least judging by expression of the *Foxi1* ionocyte
marker gene:
