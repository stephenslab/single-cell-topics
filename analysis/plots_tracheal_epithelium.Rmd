...
Notes: We identify a cluster of Goblet cells in the droplet data, but
not in the pulse-seq data (this is consistent with Montoro *et al*,
2018). 
...
cluster, with several genes (e.g. *Gp2*) showing somewhat stronger
enrichment in the topic.

```{r z-scores-droplet-G-vs-k1, fig.width=3.5, fig.height=3}
