...
Clusters suggested by PCA analysis:

```{r droplet-clustering-1, fig.height=5.25, fig.width=8}
...
Most of the samples are in the first cluster:

```{r droplet-clustering-2}
