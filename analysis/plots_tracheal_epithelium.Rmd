...
```{r pulseseq-clustering-3, fig.width=8, fig.height=3}
n   <- nrow(pca)
x   <- rep("C",n)
pc3 <- pca[,"PC3"]
pc4 <- pca[,"PC4"]
...
```{r pulseseq-clustering-4, fig.width=5, fig.height=4}
...
In summary, we have subdivided the pulse-seq data into 6 subsets. The
vast majority of the samples are in cluster A1:
