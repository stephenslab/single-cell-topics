...
Reassuringly, the topic capturing the ciliated cell-type ($k = 7$)
corresponds very closely to the "cil" cluster in the pulse-seq data.
Gene enrichments are considerably stronger in the topic for ciliated
genes, and particularly so for some genes with lower expression
levels.
...
p3 <- zscores_scatterplot(diff_count_clusters_pulseseq,
						  ...
						  label_above_score = Inf,zmax = 1000) +
...
TO DO: Show z-scores in scatterplot on square-root scale.
