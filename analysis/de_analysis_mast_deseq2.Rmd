...
```{r plot-fdr-vs-power, fig.height=3, fig.width=4}
...
At low false discovery rates, DESeq2 has a slight edge, but otherwise
the performance of all three methods is very close.
