...
```{r volcano-plots-1, fig.width=7, fig.height=5.5}
...
```{r volcano-plots-for-paper-1, echo=FALSE, warning=FALSE, results="hide"}
pp1 <- volcano_plot(diff_count_facs,"CD19+ B",genes$symbol,
                    label_above_quantile = 0.998) + ggtitle("B cells")
pp2 <- volcano_plot(diff_count_facs,"CD14+ Monocyte",genes$symbol,
                   label_above_quantile = 0.998) + ggtitle("CD14+ cells")
pp3 <- volcano_plot(diff_count_facs,"CD34+",genes$symbol,
                    label_above_quantile = 0.998) + ggtitle("CD34+ cells")
pp4 <- volcano_plot(diff_count_facs,"CD56+ NK",genes$symbol,
                    label_above_quantile = 0.998) + ggtitle("NK cells")
pp5 <- volcano_plot(diff_count_facs,"CD8+ Cytotoxic T",genes$symbol,
                   label_above_quantile = 0.998) + ggtitle("CD8+ T cells")
pp6 <- volcano_plot(diff_count_facs,"T cell",genes$symbol,
                    label_above_quantile = 0.997) + ggtitle("T cells")
...
```{r volcano-plots-for-paper-2, echo=FALSE, warning=FALSE, results="hide"}
pp7 <- volcano_plot(diff_count_clusters,"B",genes$symbol,
                    label_above_quantile = 0.998) + ggtitle("B cells")
pp8 <- volcano_plot(diff_count_clusters,"CD14+",genes$symbol,
                    label_above_quantile = 0.998) + ggtitle("CD14+ cells")
pp9 <- volcano_plot(diff_count_clusters,"CD34+",genes$symbol,
                    label_above_quantile = 0.997) + ggtitle("CD34+ cells")
pp10 <- volcano_plot(diff_count_clusters,"dendritic",genes$symbol,
                     label_above_quantile = 0.998) + ggtitle("dendritic cells")
pp11 <- volcano_plot(diff_count_clusters,"NK",genes$symbol,
                     label_above_quantile = 0.998) + ggtitle("NK cells")
pp12 <- volcano_plot(diff_count_clusters,"CD8+",genes$symbol,
                     label_above_quantile = 0.998) + ggtitle("CD8+ T cells")
pp13 <- volcano_plot(diff_count_clusters,"T",genes$symbol,
                     label_above_quantile = 0.998) + ggtitle("T cells")
...
```{r volcano-plots-11, fig.height=4, fig.width=4, eval=FALSE}
...
```{r volcano-plots-for-paper, echo=FALSE, results="hide", warning=FALSE, eval=FALSE}
...
```{r volcano-plots-3, results="hide", eval=FALSE}
