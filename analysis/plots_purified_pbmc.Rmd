...
We remove gene sets with fewer than 4 genes, and with more than 400
genes.
...
gene_set_info <-
  transform(gene_set_info,
            database = factor(paste(database,
									...
									sep = "-")))
gsea_plotly(gsea_res,gene_set_info,"k1",file = "gsea_plot_tcells.html")
gsea_plotly(gsea_res,gene_set_info,"k2",file = "gsea_plot_cd14.html")
gsea_plotly(gsea_res,gene_set_info,"k3",file = "gsea_plot_bcells.html")
gsea_plotly(gsea_res,gene_set_info,"k4",file = "gsea_plot_nk.html")
gsea_plotly(gsea_res,gene_set_info,"k5",file = "gsea_plot_cd34.html")
gsea_plotly(gsea_res,gene_set_info,"k6",file = "gsea_plot_rp.html")
```
