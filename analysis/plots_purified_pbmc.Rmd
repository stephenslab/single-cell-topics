...
p1 <- volcano_plot(res,"CD19+ B",genes$symbol,label_above_quantile = 0.9995) +
  guides(fill = "none") +
  ggtitle("B cells")
p2 <- volcano_plot(res,"CD14+ Monocyte",genes$symbol,
                   label_above_quantile = 0.9995) +
  guides(fill = "none") +
  ggtitle("CD14+ cells")
p3 <- volcano_plot(res,"CD34+",genes$symbol,label_above_quantile = 0.999) +
  guides(fill = "none") +
  ggtitle("CD34+ cells")
p4 <- volcano_plot(res,"CD56+ NK",genes$symbol,label_above_quantile = 0.9995) +
  guides(fill = "none") +
  ggtitle("NK cells")
p5 <- volcano_plot(res,"CD8+ Cytotoxic T",genes$symbol,
                   label_above_quantile = 0.9995) +
  guides(fill = "none") +
  ggtitle("CD8+ T cells")
p6 <- volcano_plot(res,"T cell",genes$symbol,label_above_quantile = 0.999) +
  guides(fill = "none") +
  ggtitle("T cells")
...
pp1 <- volcano_plot(res,"CD19+ B",genes$symbol,label_above_quantile = 0.998) +
  guides(fill = "none") +
  ggtitle("B cells")
pp2 <- volcano_plot(res,"CD14+ Monocyte",genes$symbol,
                   label_above_quantile = 0.998) +
  guides(fill = "none") +
  ggtitle("CD14+ cells")
pp3 <- volcano_plot(res,"CD34+",genes$symbol,label_above_quantile = 0.998) +
  guides(fill = "none") +
  ggtitle("CD34+ cells")
pp4 <- volcano_plot(res,"CD56+ NK",genes$symbol,
                    label_above_quantile = 0.998) +
  guides(fill = "none") +
  ggtitle("NK cells")
pp5 <- volcano_plot(res,"CD8+ Cytotoxic T",genes$symbol,
                   label_above_quantile = 0.998) +
  guides(fill = "none") +
  ggtitle("CD8+ T cells")
pp6 <- volcano_plot(res,"T cell",genes$symbol,label_above_quantile = 0.997) +
  guides(fill = "none") +
  ggtitle("T cells")
...
```{r volcano-plots-11, fig.height=4, fig.width=4}
...
```{r volcano-plots-12, fig.width=7, fig.height=8}
