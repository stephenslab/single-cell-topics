...
```{r volcano-plots-1, fig.height=4, fig.width=5}
...
```{r volcano-plots-for-paper, echo=FALSE, results="hide", eval=FALSE}
ggsave("../plots/volcano_plot_pbmc_purified_bcells.eps",
       p2,height = 1.5,width = 8)
```

*Add text here.*

```{r topics-vs-facs-scatterplots, eval=FALSE}
