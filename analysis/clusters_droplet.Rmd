...
p8   <- pca_hexbin_plot(fit2,1:2,breaks = breaks) + guides(fill = "none")
plot_grid(p7,p8)
```
...
```{r pca-plot-club, fig.width=6, fig.height=4.75}
...
Although subtle, there is variation in topic 2 and 6 within the T+N
