...
```{r clustering-6, fig.width=4, fig.height=2.5}
pca  <- prcomp(fit2$L)$x
pc1  <- pca[,1]
pc2  <- pca[,2]
...
Note the distribution of the topics in cluster C that there is further
substantial heterogeneity in these cells beyond what can be captured
by hard clustering. In particular, there is additional continuous
variation in gene expression primarily captured by topics 5 and 7:
