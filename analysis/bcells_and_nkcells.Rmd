...
```{r pbmc-purified-3-vs-B, fig.width=7, fig.height=3}
...
```{r z-scores-pbmc-68k-5-vs-A2, fig.width=7, fig.height=3}
...
```{r z-scores-pbmc-purified-4-vs-A1, fig.width=7, fig.height=3}
...
```{r z-scores-pbmc-68k-3-vs-A1b, fig.height=3.75, fig.width=4.5, eval=FALSE}
