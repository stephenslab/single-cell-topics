...
cells, CD14+ cells and CD34+ cells. (See the very bottom of this
analysis for quick check that these cluster labels make sense.) The
remaining cells are assigned to the U cluster ("U" for "unknown"). (We
labels "B", "CD14+" and "CD34+" so that we can conveniently refer to
them, noting that the labels are informed by downstream analyses.)
