...
```{r bcells-volcano-plot, fig.height=4, fig.width=6, warning=FALSE}
volcano_plot(de,k = "k3",ymax = 150,labels = genes$symbol)
```

These same results can also be explored in an interactive volcano
plot (you can view the plot [here](de_analysis_purified_pbmc_bcells.html):

```{r bcells-volcano-plotly, results="hide"}
