...
```{r volcano-plots, fig.height=6, fig.width=8, warning=FALSE}
...
+ [T cells](de_analysis_purified_pbmc_tcells.html)

+ [CD14+ monocytes](de_analysis_purified_pbmc_cd14.html)

+ [B cells](de_analysis_purified_pbmc_bcells.html)

+ [Natural killer cells](de_analysis_purified_pbmc_nkcells.html)

+ [CD34+](de_analysis_purified_pbmc_cd34.html)

+ [Ribosomal protein genes](de_analysis_purified_pbmc_ribosome.html)
