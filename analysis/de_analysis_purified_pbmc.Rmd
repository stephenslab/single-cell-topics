...
```{r structure-plot, fig.width=8, fig.height=1.8, eval=FALSE}
...
In particular, topics 1--4 closely correspond, respectively, to T
cells, CD14+ monocytes (myeloid cells), B cells annd natural killer
...
of the CD34+ cells. Topic 6 does not correspond to any FACS cell type
and as we will it is capturing a different characteristic of the
