...
the dendritic cells actually yields a *better* fit than the topic
model. However, because only 308 cells are in this cluster (0.3%
of the total), the overall impact on model fit is small.
...
ggsave("../plots/loglik_histogram_by_facs_pbmc_purified.eps",
