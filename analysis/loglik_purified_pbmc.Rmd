...
underlying pattern of expression. This serves as a simple "sanity
check", as we expect the fit to improve with the more flexible topic
model.
...
The improvement in fit is greatest for the CD34+ and T cell FACS
subpopulations:
