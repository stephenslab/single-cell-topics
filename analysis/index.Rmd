...
In these pages, we compare the quality of the Poisson NMF fits
obtained by performing the different updates (EM, CCD, SCD, with and
without extrapolation), and with different ranks, $k$.
...
+ [Mixture of FACS-purified PBMCs](plots_pbmc.html)

+ [PBMC 68k](plots_68k_pbmc.html)

+ [Droplet](plots_droplet.html)

+ [Pulse-seq](plots_pulseseq.html)
