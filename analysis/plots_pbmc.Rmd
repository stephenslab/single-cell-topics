...
+ Give better names to the clusters in the purified data.
...
rows <- sort(c(sample(which(samples_purified$cluster == "NK"),250),
               sample(which(samples_purified$cluster == "A2a"),250),
               sample(which(samples_purified$cluster == "A2b"),1200),
...
clusters (labeled NK, B, C1, C2). And, indeed, they align closely with
...
+ Because of their close correspondence, subsequent analysis of topics
  ...
  NK, B, C1, C2. For example, cluster B corresponds almost exactly to
