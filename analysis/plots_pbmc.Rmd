...
three large clusters as "A", "B" and "C". Since there are so many
samples, the scatterplot suffers from "overplotting", so it also
helpful to view this PC projection as a density plot ("hex plot").
...
There also appears to be finer scale structure. We will examine this
finer scale structure below.
...
TO DO: Mention idea of a "background cluster"---a third subset of
samples that do not fit well in the two clusters.
