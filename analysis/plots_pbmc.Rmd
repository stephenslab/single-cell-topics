...
```{r load-68k-fit}
resultdir <- "../output/pbmc-68k"
fit_68k <- readRDS(file.path(resultdir,"rds/fit-pbmc-68k-scd-ex-k=6.rds"))$fit
load(file.path(resultdir,"postfit-pbmc-68k-scd-ex-k=6.RData"))
