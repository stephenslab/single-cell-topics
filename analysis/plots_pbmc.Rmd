...
+ As we discovered about, unlike the FACS-purified data, don't
  identify a clear-cut cluster for NK cells; the NK cells are mixed in
  with the T-cells (subset A1). NK cells will therefore only emerge
  only after subsequent analysis of topic 3.
