...
community detection methods such as the Louvain algorithm often have
difficulty identifying very small clusters.
...
+ As in the purified fit, here we identify a B-cells cluster (B) and
  topic (5) that closely align.

+ We also identify what is most likely a cluster of CD34+ cells.

+ We don't identify a clear-cut cluster for NK cells; the NK cells are
  mixed in with the T-cells (subset A1), and NK cells will emerge only
  after subsequent analysis of topic 3.
...
In summary, the topics and clusters seem to be more complementary each
other in this case, and it remains to be seen whether both the topics
and clusters offer biological insights.
