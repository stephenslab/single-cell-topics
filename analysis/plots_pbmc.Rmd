...
+ The small number (~1%) of A3 and B3 cells aren't distinct
  subpopulations *per se* but rather appear to be in some
  "intermediate" developmental state, and the mixture of topics
  captures this.
