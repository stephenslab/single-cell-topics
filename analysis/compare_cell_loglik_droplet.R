...
loglik_cluster <- loglik_multinom_topic_model(counts,
                                              poisson2multinom(fit_cluster))
loglik_montoro <- loglik_multinom_topic_model(counts,
                                              poisson2multinom(fit_montoro))
